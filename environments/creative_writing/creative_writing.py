...
# Heavy deps are lazy-imported so the module can be imported in CI
...
def build_dataset(num_examples: int = 5000, seed: int = 42):
...
# --- Wire it together ---
def load_environment(num_examples: int = 5000):
